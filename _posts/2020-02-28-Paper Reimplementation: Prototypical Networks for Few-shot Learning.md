...
作者在Omniglot上的结果是96%以上，在miniImageNet上5way的结果是49和68，在CUB-200上的zero-shot结果是54.6%，这个准确率在当时还是相当高的。我的结果还没跑完，跑完了会列个表放上来。总之作者用了一套比较简单的思路就达到了比较好的结果，还是挺厉害的。此外，由于小样本的训练方法刚开始接触会觉得有些陌生，所以实现起来也会麻烦许多，不过随着对于训练方式的适应程度慢慢加深，代码写起来应该会快很多。  
